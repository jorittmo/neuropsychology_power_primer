...
primer), and associated power calculations (Rittmo & McIntosh, 2020).
...
# The origins and limits of power in a case-control comparisons {#section3}
...
would be shifted to a score of -1, and the deficit would not be detected. In
...
and the power of our test would be exactly .50. Power for a case-comparison test
...
(alpha) criterion of .05 (equivalent curves for alphas of .1 and .025 are also
